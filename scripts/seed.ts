...
async function main() {
  ...
  const clientRows = await db
    ...
    .values([
      ...
      },
      {
        ...
        status: "active",
        referralSource: "Referido de cliente",
        interestedServices: ["company_registration"],
        notes: SEED_TAG,
      },
      {
  ...
  const caseRows = await db
    ...
    .values([
      ...
      {
        clientId: byName("Sandra Lopez").id,
        serviceType: "company_registration",
        status: "in_progress",
        title: "LLC registration — Lopez Cleaning Services",
        dueDate: dateOnly(daysFromNow(10)),
        fee: "350.00",
        notes: SEED_TAG,
      },
      {
        clientId: byName("Brian Foster").id,
        serviceType: "leadership",
        status: "new",
        title: "Leadership coaching — small team workshop",
        dueDate: dateOnly(daysFromNow(15)),
        fee: "600.00",
        notes: SEED_TAG,
      },
    ])
  ...
  await db.insert(appointments).values([
    ...
    {
      clientId: byName("Sandra Lopez").id,
      caseId: byTitle("LLC registration — Lopez Cleaning Services").id,
    ...
    {
      clientId: byName("Brian Foster").id,
      caseId: byTitle("Leadership coaching — small team workshop").id,
      title: "Leadership workshop kickoff",
      serviceType: "leadership",
  ...
  const invoiceSeed: Array<{
    ...
    },
    {
      ...
      caseTitle: "LLC registration — Lopez Cleaning Services",
      status: "unpaid",
      issueDaysAgo: 3,
      dueDaysFromIssue: 14,
      paid: false,
      items: [
        { description: "LLC registration filing assistance", quantity: "1", unitPrice: "350.00" },
      ],
    },
  ];
